            ...
            <div class="c-table01 is-top">
              <table>
                <tbody>
                  <tr>
                    <th>職種/仕事内容</th>
                    <td>[1]看護師<br class="u-view-sp">看護業務、院内雑務、備品管理など<br>[2]受付…窓口対応、診療補助、備品管理など</td>
                  </tr>
                  <tr>
                    <th>対象となる方</th>
                    <td>[1]看護師免許をお持ちの方<br>[3]経験者大歓迎！未経験・第二新卒・ブランクもOK<br><span class="c-note01">喫煙に関しては、当社服務規程あり</span>
                    </td>
                  </tr>
                  <tr>
                    <th>勤務地</th>
